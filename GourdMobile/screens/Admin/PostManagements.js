...
import { View, Text, FlatList, TouchableOpacity, Modal, StyleSheet, ActivityIndicator, Image, Pressable, Animated } from 'react-native';
...
const AdminPostManagement = () => {
  ...
  const confirmDelete = async () => {
    try {
      ...
      showToastify("success", "Post deleted!");
    } catch (error) {
      showToastify("error", "Error deleting post");
    }
    setDeleteId(null);
  };
